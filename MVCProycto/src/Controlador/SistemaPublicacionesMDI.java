...
public class SistemaPublicacionesMDI extends javax.swing.JFrame {
       ...
       private JInternalFranmeRevistas Revistas;
    private int MAXIMIZEED_BOTH;
    
    public SistemaPublicacionesMDI() {
        initComponents();
        this.setExtendedState(MAXIMIZEED_BOTH);
        ...
        desktoPane.add(Revistas);
        
        
    }
    private void jMenuItemRevistaActionPerformerd(java.awt.event.ActionEvent evt) { 
    ...
    private void initComponents() {
        ...
        jMenuItemRevistas.setMnemonic('c');
        jMenuItemRevistas.setText("Ver Revistas");
        helpMenu.add(jMenuItemRevistas);
    ...
    private static class JInternalFranmeRevistas {

        public JInternalFranmeRevistas() {
        }
    ...
    private static class JInternalFrameRevistas extends JInternalFranmeRevistas {

        public JInternalFrameRevistas() {
        }
    }

    private static class desktoPane {

        private static void add(JInternalFranmeRevistas Revistas) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
